...
/*
    static err_t ICACHE_FLASH_ATTR pptpInterfaceOutput(struct netif *netif, struct pbuf *p, const ip_addr_t *ipaddr);
    static err_t ICACHE_FLASH_ATTR pptpLwipInit(struct netif *netif);
    struct PptpInterfaceData ICACHE_FLASH_ATTR *pptpInterfaceAdd();
*/    
